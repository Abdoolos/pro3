...
<div className='row' style={{display:'flex',gap:'14px',alignItems:'flex-start',margin:'12px 0'}}><strong>{t('contact.phone')}</strong><div>0047-48672158</div></div>
<div className='row' style={{display:'flex',gap:'14px',alignItems:'flex-start',margin:'12px 0'}}><strong>{t('contact.email')}</strong><div>Mahadehussein3@gmail.com</div></div>
