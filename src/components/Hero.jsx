...
export default function Hero(){
  ...
  return (
    ...
    >
      ...
      <div className="container relative" style={{display:"grid",gap:40,gridTemplateColumns:"1.1fr 1fr",alignItems:"center",zIndex:1}}>
        <div>
          ...
          <div style={{display:"flex",gap:14,marginTop:28,position:"relative",zIndex:2,pointerEvents:"auto"}}>
            <button 
